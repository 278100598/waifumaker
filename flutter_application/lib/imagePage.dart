...
class HttpService {
  final String gets3listURL = "http://127.0.0.1:11234/get/s3_list";
          ...
          if (objects[0].toString().contains(".jpg")) {
            ...
            for (var object in objects) {
              if(object.toString().contains("preview")) {
                images.add("http://127.0.0.1:11234/get?URL=$s3_url${object.toString()}");
              } else {
                original_images.add("http://127.0.0.1:11234/get?URL=$s3_url${object.toString()}");
              }
            }
